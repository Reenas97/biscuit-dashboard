...
export function PlanningPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    saveTasks([{ id: crypto.randomUUID(), title: form.title.trim(), date: form.date, priority: form.priority, projectId: form.projectId || undefined, completed: false, createdAt: new Date().toISOString() }, ...tasks])
    setForm(null)
  }
